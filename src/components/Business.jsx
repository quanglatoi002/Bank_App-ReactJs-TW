...
const FeatureCard = ({ icon, title, content, index }) => (
    <div
        ...
        rounded-[20px] featureRounded ${index === features.length - 1 ? 'mb-0' : 'mb-6'}`}
    >
        <div
        ...
        <div className="flex-1 flex flex-col ml-3 font-poppins">
            <h4 className="font-semibold text-[18px] leading-[23px] capitalize text-white mb-2">{title}</h4>
            <p className="font-normal text-16px] leading-[24px] text-dimWhite">{content}</p>
        </div>
    </div>
);
...
const Business = () => (
    <section id="features" className={layout.section}>
        ...
        <div className={`${layout.sectionImg} md:ml-[4.5rem] flex-col flex-[64%]`}>
